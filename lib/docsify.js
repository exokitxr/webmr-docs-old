...
function main(config) {
  var aside =
    ...
    '<aside class="sidebar">' +
    (config.name ?
      ("<h1 style=\"display: flex; align-items: center; justify-content: center;\"><img src=\"docs/_images/icon.png\" style=\"width: 40px; margin-right: 10px;\"><a class=\"app-name-link\" data-nosearch>" + (config.name) + "</a></h1>") :
      '') +
